        ...
        >
          <div className="relative p-4 w-full max-w-md">
            ...
            <div className="relative p-4 text-center bg-white rounded-lg shadow sm:p-5">
              ...
              <button
                type="button"
                className="py-2 px-3 text-sm font-medium text-white rounded-lg bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300"
                onClick={toggleModal}
              >
                Continue
              </button>
